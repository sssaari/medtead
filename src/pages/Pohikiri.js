  ...
  return (
    <div>
      ...
      <div className="articleBox">
        ...
        <h3>MTÜ eesmärk:</h3>
        <p>
          a) võimaldada avalikku vaba arutelu eelkõige tervist puudutavates, aga
          ka teistes ühiskonnas laia kõlapinda/tähtsust omavates küsimustes, sh
          pakkuda/otsida platvormi (avatud) diskussiooniks kodulehekülje,
          sotsiaalmeedia, avaliku meedia jne vahendusel.
          <br />
        ...
        <p>
          ...
          seisukohtade kujundamisel ning osaleda ühingu tegevuste elluviimisel.
          <br />
          MTÜ liikmete kohustusteks on maksta liikmemaksu (selle esialgne suurus
          30 euri aastas) ja osaleda üldkoosolekul.
          <br />
        ...
        <p>
          ...
          <br />
          Üldkoosoleku otsus on vastu võetud, kui selle poolt hääletab vähemalt
          50% + 1 üldkoosolekul osalevatest liikmetest.
          <br />
